...
public class BreadthFirstDirectedPaths {
     ...
     */
    public BreadthFirstDirectedPaths(LCAjava G, int s) {
     ...
     */
    public BreadthFirstDirectedPaths(LCAjava G, Iterable<Integer> sources) {
        marked = new boolean[G.V()];
        distTo = new int[G.V()];
        edgeTo = new int[G.V()];
        for (int v = 0; v < G.V(); v++)
    ...
    private void bfs(LCAjava G, int s) {
    ...
    private void bfs(LCAjava G, Iterable<Integer> sources) {
        Queue<Integer> q = new Queue<Integer>();
        for (int s : sources) {
            marked[s] = true;
            distTo[s] = 0;
